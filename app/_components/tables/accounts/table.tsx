...
interface AccountTableProps<TData, TValue> {
  ...
  data: TData[];
  setIsAddAccountOpen?: (value: boolean) => void;
      ...
      <div className="flex  flex-wrap md:space-x-3 items-center py-4 relative space-y-2 md:space-y-0 justify-start md:justify-end">
        {!isAddAccountOpen && !updateOpen && (
          <Button
            ...
            style={{ zIndex: 50 }}
            onClick={() => {
              return setIsAddAccountOpen && setIsAddAccountOpen(true);
            }}
          >
            Create Account
          </Button>
        ...
        {isAddAccountOpen && (
          <Button
            ...
            style={{ zIndex: 50 }}
            onClick={() => {
              return setIsAddAccountOpen && setIsAddAccountOpen(false);
            }}
          >
            Close Create
          </Button>
